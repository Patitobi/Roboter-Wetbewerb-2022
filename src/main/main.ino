...
void USSDebug(){
	Serial.println("USS1: " + String(entfernung[0]));
	Serial.println("USS2: " + String(entfernung[1]));
	Serial.println("USS3: " + String(entfernung[2]));
	Serial.println("USS4: " + String(entfernung[3]));
}
class IR{
	public:
	//IR
	String hexvalue;
	const long TurnONCode = 0x1234; //Platzhalter für Fernbedienungs code um an zu schalten
